...
module "webserver_cluster" {
  ...
  source = "github.com/michaelJava69/terraform-up-and-running-code//code/terraform/04-terraform-module/module-example/modules/services/webserver-cluster?ref=v0.2.2"
